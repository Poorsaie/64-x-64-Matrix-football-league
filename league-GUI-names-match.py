...
tree_schedule.column("Week", width=80, anchor=tk.CENTER)
tree_schedule.column("Match", width=300, anchor=tk.CENTER)
tree_schedule.column("Winner", width=150, anchor=tk.CENTER)
